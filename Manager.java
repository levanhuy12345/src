...
public class Manager {
    ...
    public static int countLine() {
        int countLine = 0;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("C:\\Users\\PC\\Downloads\\src (3).zip\\src\\normalizetext\\input.txt")));
            PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\PC\\Downloads\\src (3).zip\\src\\normalizetext\\output.txt", true)));
            String line;
